...
class PGConnector(DBConnector):
    ...
    def get_relations_info(self, filter_layer_list=[]):
        if self.schema:
            ...
            cur.execute("""SELECT RC.CONSTRAINT_NAME, KCU1.TABLE_NAME AS referencing_table, KCU1.COLUMN_NAME AS referencing_column, KCU2.CONSTRAINT_SCHEMA, KCU2.TABLE_NAME AS referenced_table, KCU2.COLUMN_NAME AS referenced_column, KCU1.ORDINAL_POSITION, META_ATTRS.attr_value as strength
